...
void kmeans_gpu(params params, int *cluster_info){
    ...
    */
    ...
    cal_distance_share<<<grid2d_cluster_obj, block2d_16, params.obj_dimension * BLOCKSIZE_16 * sizeof(flo) * 2>>>(dev_data, dev_center_data, dev_distance, params.obj_num, params.cluster_num, params.obj_dimension);
